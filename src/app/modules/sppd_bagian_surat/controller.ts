...
class BagianSuratController extends MainRoutes {
    public routes(): void {
        /** [GET] - Fetch Data */
        ...
        /** [GET] - Find By Id  */
        this.router.get('/:bagian_surat_id', authMiddleware, ReqValidation.paramValidation, async (req: Request, res: Response) => {
        ...
        /** [DELETE] - Delete Data */
        this.router.delete('/:bagian_surat_id', authMiddleware, ReqValidation.paramValidation, async (req: I_RequestCustom, res: Response) => {
