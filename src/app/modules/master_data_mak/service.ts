...
import { MasterDataMAKRepository } from './repository';
...
class MasterDataMAKService {
    private readonly repository = new MasterDataMAKRepository();
...
export default new MasterDataMAKService();
