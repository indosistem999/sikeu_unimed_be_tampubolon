...
class MasterSumberDanaController extends MainRoutes {
  public routes(): void {
    /** [GET] - Fetch Data */
    ...
    /** [GET] - Find By Id  */
    this.router.get('/:sumber_dana_id', authMiddleware, ReqValidation.paramValidation, async (req: Request, res: Response) => {
    ...
    /** [DELETE] - Delete Data */
    this.router.delete('/:sumber_dana_id', authMiddleware, ReqValidation.paramValidation, async (req: Request, res: Response) => {
      await Services.softDelete(req, res);
    });
  }
}

export default new MasterSumberDanaController().router;
