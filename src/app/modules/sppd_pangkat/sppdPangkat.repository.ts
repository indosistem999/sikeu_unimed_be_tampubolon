...
export class SPDPangkatRepository implements I_SPDPangkatRepository {
    ...
    async store(payload: Record<string, any>): Promise<I_ResultService> {
        try {
            ...
            return {
                success: true,
                message: MessageDialog.__('success.spdPangkat.store'),
                record: result
            }
        } catch (err: any) {
    ...
    async update(id: string, payload: Record<string, any>): Promise<I_ResultService> {
        try {
            ...
            return {
                success: true,
                message: MessageDialog.__('success.spdPangkat.update'),
                record: {
    ...
    async softDelete(id: string, payload: Record<string, any>): Promise<I_ResultService> {
        try {
            ...
            return {
                success: true,
                message: MessageDialog.__('success.spdPangkat.softDelete'),
                record: {
                    unit_id: id
                }
            }
