...
import { SPDPangkatRepository } from './sppdPangkat.repository';
import { I_SPDPangkatService } from '../../../interfaces/spdPangkat.interface';
...
class SPDPangkatService implements I_SPDPangkatService {
    private readonly repository = new SPDPangkatRepository();
    ...
    async fetchById(req: Request, res: Response): Promise<Response> {
        const id: string = req?.params?.[sc.spd_pangkat.primaryKey]
...
export default new SPDPangkatService();
