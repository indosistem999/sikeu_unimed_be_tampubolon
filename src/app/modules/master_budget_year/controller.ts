...
class MasterBudgetYearController extends MainRoutes {
    public routes(): void {
        /** [GET] - Fetch Data */
        ...
        /** [GET] - Find By Id  */
        this.router.get('/:budget_id', authMiddleware, ReqValidation.paramValidation, async (req: Request, res: Response) => {
        ...
        /** [DELETE] - Delete Data */
        this.router.delete('/:budget_id', authMiddleware, ReqValidation.paramValidation, async (req: Request, res: Response) => {
            await Services.softDelete(req, res);
        });
    }
}

export default new MasterBudgetYearController().router;